...
//                                            crawler.onBeforeExit();
     ...
     *            the URL of the seed
     * @param crawlId
     *            the unique id of the crawl
     */
    public void addSeed(String pageUrl, String crawlId) {
        addSeed(pageUrl, -1, crawlId);
    }
     ...
     *
     */
    public void addSeed(String pageUrl, int docId, String crawlId) {
